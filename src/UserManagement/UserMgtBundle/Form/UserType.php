...
class UserType extends AbstractType
{
    ...
    {
        $builder->add('fname', 'text', array('constraints' => array( new NotBlank(array('message' => 'First Name is required'))),'label' => false , 'attr' => array('placeholder' => 'First Name', 'class' => 'form-control')));
        $builder->add('lname', 'text', array('constraints' => array( new NotBlank(array('message' => 'Last Name is required'))),'label' => false , 'attr' => array('placeholder' => 'Last Name', 'class' => 'form-control')));
