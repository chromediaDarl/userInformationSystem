...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserInformationUserBundle', '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/Resources/UserInformationUserBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'UserInformationUserBundle', '/Applications/XAMPP/xamppfiles/htdocs/sample-login/src/UserInformation/UserBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/Resources');
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'sample-login', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array()), $b, new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $a->setNamespace('sf2orm_default_3020b16a5259e51fd14f421627c99c74c30421171b8bc0ec35d3ce9d24772ff0');

        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_3020b16a5259e51fd14f421627c99c74c30421171b8bc0ec35d3ce9d24772ff0');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_3020b16a5259e51fd14f421627c99c74c30421171b8bc0ec35d3ce9d24772ff0');

        $d = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $d->addDriver(new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($this->get('annotation_reader'), array(0 => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/src/UserInformation/UserBundle/Entity')), 'UserInformation\\UserBundle\\Entity');

        $e = new \Doctrine\ORM\Configuration();
        $e->setEntityNamespaces(array('UserInformationUserBundle' => 'UserInformation\\UserBundle\\Entity'));
        $e->setMetadataCacheImpl($a);
        $e->setQueryCacheImpl($b);
        $e->setResultCacheImpl($c);
        $e->setMetadataDriverImpl($d);
        $e->setProxyDir('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app', 'UTF-8'));
        ...
        $instance->addExtension(new \Symfony\Bundle\AsseticBundle\Twig\AsseticExtension($this->get('assetic.asset_factory'), $this->get('templating.name_parser'), true, array(), array(0 => 'UserInformationUserBundle'), $this->get('assetic.value_supplier.default', ContainerInterface::NULL_ON_INVALID_REFERENCE)));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/src/UserInformation/UserBundle/Resources/views', 'UserInformationUser');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/Resources/views');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('b77ef3b36c1c5828ee2e8a61d8eb8f5b23885648');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'ap_',
            'kernel.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev',
            'kernel.logs_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/logs',
            'kernel.bundles' => array(
                ...
                'UserInformationUserBundle' => 'UserInformation\\UserBundle\\UserInformationUserBundle',
            ...
            'locale' => 'en',
            'secret' => 'b77ef3b36c1c5828ee2e8a61d8eb8f5b23885648',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => 'b77ef3b36c1c5828ee2e8a61d8eb8f5b23885648',
            ...
            'session.save_path' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/assetic',
            'assetic.bundles' => array(
                0 => 'UserInformationUserBundle',
            ),
            ...
            'assetic.read_from' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/../web',
            'assetic.write_to' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/../web',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/XAMPP/xamppfiles/htdocs/sample-login/app/cache/dev/doctrine/orm/Proxies',
